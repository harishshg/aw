...
const PhoneStep = ({ phoneNumber, setAnswerField, handlePhoneSubmit }) => {
    ...
    const phoneInputContent = (
        <div className="w-full text-left flex justify-start">
            <div className={`w-full max-w-sm space-y-6 transition-all duration-1000 ease-out ${transitionClasses}`}>

                {/* Phone Field */}
                <div className="relative">
                    <input
                        type="tel" // Use tel for mobile keyboard on devices
                        placeholder="PHONE NUMBER"
                        value={phoneNumber}
                        // Redux update: set the 'phoneNumber' field
                        onChange={(e) => {
                            // Basic number formatting (e.g., (123) 456-7890) can be added here
                            setAnswerField('phoneNumber')(e.target.value)
                        }}
    ...
    return (
        <div className="w-full flex justify-start">
            <div className="max-w-xl w-full flex flex-col items-start ml-10"> {/* Adjusted alignment */}

                {/* Left-Aligned Avatar and Text Container */}
                <div className="w-full max-w-lg flex items-start mb-8">
                    <div className="w-20 h-20 rounded-full overflow-hidden mr-4 mt-1 flex-shrink-0">
                        <BotAvatar />
                    </div>
                ...
                <RenderChatStep
                    ...
                    inputContent={isTypingComplete ? phoneInputContent : null}
